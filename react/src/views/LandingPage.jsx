  ...
  return (
    ...
    <div className="absolute inset-0 -z-10 h-full w-full bg-primary-base [background:radial-gradient(125%_125%_at_50%_10%,#265073_40%,#2D9596_100%)]">
            <div className='flex flex-col justify-center w-full h-screen gap-y-32'>
                ...
                <h3 className='text-center font-content text-white text-xl m-3'>Vaša potraga za savršenim poslom počinje ovdje. Pronađite idealnu priliku već danas!</h3>
                ...
                {userLoggedIn ? <Link className="text-white bg-secondary-base px-4 lg:px-6 py-2 rounded-md font-open text-xl my-2 lg:my-10 mx-2 lg:mx-5"to="/register">Pronađi posao ili radnika</Link> : 
