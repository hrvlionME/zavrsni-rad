  ...
  return (
    ...
    <div className="absolute inset-0 -z-10 h-full w-full bg-primary-base [background:radial-gradient(125%_125%_at_50%_10%,#265073_40%,#2D9596_100%)] overflow-y-scroll no-scrollbar">
            ...
            <div className='flex flex-col justify-center'>
                ...
                <input className="font-open text-2xl px-2 py-4 lg:w-1/3 md:w-1/2 sm:w-3/4 rounded-lg mx-auto my-5 shadow-md" ref={nameRef} type="text" placeholder='Ime i prezime' />
                <input className="font-open text-2xl px-2 py-4 lg:w-1/3 md:w-1/2 sm:w-3/4 rounded-lg mx-auto my-5 shadow-md" ref={emailRef}type="text" placeholder='Email' />
                <input className="font-open text-2xl px-2 py-4 lg:w-1/3 md:w-1/2 sm:w-3/4 rounded-lg mx-auto my-5 shadow-md" ref={passwordRef}type="text" placeholder='Lozinka' />
                <input className="font-open text-2xl px-2 py-4 lg:w-1/3 md:w-1/2 sm:w-3/4 rounded-lg mx-auto my-5 shadow-md" ref={passwordConfirmationRef}type="text" placeholder='Potvrda lozinke' />
            </div> 
            : progress == 33 ? 
            ...
            <div className='flex justify-center'>
                ...
                <div class="absolute bottom-0 px-4 py-3 bg-secondary-base/50 w-full flex justify-center">
            ...
            <div className='flex flex-col justify-center'>
                ...
                <textarea className="font-open text-2xl px-2 py-4 lg:w-1/3 md:w-1/2 sm:w-3/4 rounded-lg mx-auto my-5 shadow-md"type="text" placeholder='Recite nešto više o sebi' rows={6} />
